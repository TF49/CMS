...
public class ComponentStyle
{
    ...
    // 带边框的文本框样式
    public static void setFormStyleWithBorder(JTextField textField, int fontSize, Color foreground, Color borderColor, int x, int y, int width, int height, Container container)
    {
        textField.setFont(new Font("微软雅黑", Font.PLAIN, fontSize));
        textField.setForeground(foreground);
        textField.setBackground(Color.WHITE);
    ...
    public static void setFormStyle(JComponent component, String fontName, int fontStyle, int fontSize, Color foreground, Color background, int x, int y, int width, int height, Container container)
    {
